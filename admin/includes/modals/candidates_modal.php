    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="constituency" class="col-sm-3 control-label">constituency</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="candidates_edit.php">
          ...
          <div class="form-group">
            <label for="edit_constituency" class="col-sm-3 control-label">Constituency</label>

            <div class="col-sm-9">
              <select class="form-control" id="edit_constituency" name="constituency" required>
