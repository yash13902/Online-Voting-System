...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p>No. of Constituencies</p>
              </div>
              <div class="icon">
                <i class="fa fa-tasks"></i>
              </div>
              <a href="constituencies.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-xs-6">
        ...
        <?php
        $sql = "SELECT * FROM constituencies ORDER BY priority ASC";
        $query = $conn->query($sql);
        $inc = 2;
  ...
  $query = $conn->query($sql);
  while ($row = $query->fetch_assoc()) {
    $sql = "SELECT * FROM candidates WHERE constituency_id = '" . $row['id'] . "'";
