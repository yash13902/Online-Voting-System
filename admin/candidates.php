            ...
            <div class="box">
              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT *, candidates.id AS canid FROM candidates LEFT JOIN constituencies ON constituencies.id=candidates.constituency_id ORDER BY constituencies.priority ASC";
    ...
    function getRow(id) {
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#posselect').val(response.constituency_id).html(response.description);
